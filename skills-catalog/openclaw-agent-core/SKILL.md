...
description: Use when working in openclaw-monitor on AdMate Agent Core, Openclaw, Hermes, Sentinel Live Monitoring, Slack/Email alerts, operator_actions, audit_logs, users/permissions, Command Center Auth/DB/API, and LLM cost tracking.
---

# Openclaw Agent Core Skill

Use this skill for `openclaw-monitor`.
...
```text
C:\Users\Administrator\projects\admate-docs\strategy\15_AdMate_Command_Center_Executive_Dashboard_PRD_v1.md
```
...
3. Treat `openclaw-monitor` as the source of truth for operational data, Auth, DB, APIs, permissions, and audit logs.
