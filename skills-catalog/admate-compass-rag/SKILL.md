...
description: Use when working on AdMate Compass / Jhongjin-admate-guide-codex for advertising policy RAG, crawlers, document parsing, hybrid search, answer grounding, citation/source display, Multi-LLM validation, and RAG UI improvements.
---

# AdMate Compass RAG Skill

Use this skill for `Jhongjin-admate-guide-codex`.
