...
운영 전환 과정에서 추가된 핵심 문서:

| 번호 | 문서명 | 목적 | 주요 독자 |
|---|---|---|---|
| 15 | AdMate Command Center Executive Dashboard PRD v1 | 임원용 프로젝트 진행 현황 대시보드의 목적, 데이터 구조, 표시 원칙 정의 | 임원, PM, Openclaw/Homepage 담당 Agent |
| 17 | AdMate User Access Roles and Approval Model v1 | 접근 요청, 승인/반려, system/project/Hermes 권한 3축 모델 정의 | 관리자, 보안/ISMS 담당자, Openclaw 담당 Agent |
